<template>
  <div class="index">
    ...
    <div class="channel">
      <div @click="categoryListBychannel(item.url)" v-for="(item, index) in channel" :key="index">
  ...
  methods: {
    ...
    async getData() {
     ...
     console.log("index-data",data);
      ...
      this.newGoods = data.data.newGoodsList;
      this.hotGoods = data.data.hotGoodsList;
    ...
    categoryListBychannel(url) {  //通过频道进入分类明细页签
      wx.navigateTo({
        url: url
      });
    },
